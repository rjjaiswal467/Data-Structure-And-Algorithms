...
class Intersection_Union {
    ...
    {
        Intersection_Union llist1 = new Intersection_Union();
        Intersection_Union llist2 = new Intersection_Union();
        Intersection_Union unin = new Intersection_Union();
        Intersection_Union intersecn = new Intersection_Union();
